...
export default function SwipeClient({ initialItems, currentUserId }: SwipeClientProps) {
    ...
    const swipeFeedItems = useMemo(() => {
        ...
        return nearbyItems.map(item => ({
            ...item,
            city: location?.city ? location.city : item.city
        }))
    ...
    return (
        <div className="fixed inset-0 min-h-dvh flex flex-col bg-background text-text-primary overflow-y-auto overscroll-none pt-[60px] lg:pt-[70px] pb-[80px] lg:pb-4">
