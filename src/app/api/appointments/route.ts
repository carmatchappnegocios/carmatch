...
export async function POST(request: Request) {
    try {
        ...
        const appointment = await prisma.appointment.create({
            data: {
                chatId,
                proposerId: (session.user as any).id,
                date: new Date(date),
                location,
        ...
        const receiverId = appointment.chat.buyerId === (session.user as any).id
        ...
        await upsertNotification({
            ...
            link: `/messages/${chatId}?appointmentId=${appointment.id}`,
            metadata: {
        ...
        await sendPushToUser(receiverId, {
            ...
            url: `/messages/${chatId}?appointmentId=${appointment.id}`,
