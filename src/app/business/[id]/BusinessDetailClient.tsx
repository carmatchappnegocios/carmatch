        ...
        try {
            ...
            if (res.ok) {
                ...
                setModal({
                    ...
                    message: isInsufficientCredits ? 'Para continuar con esta acción es necesario actualizar tu plan de servicios.' : (data.error || 'No se pudo actualizar el estado.'),
                    ...
                    <div className="flex-1 space-y-4">
                        ...
                        {!business.isActive && isExpired && (
                            <p className="text-amber-400 text-xs font-bold flex items-center gap-1.5">
                                <ShieldCheck size={14} />
                                Requiere validación de seguridad para renovar y activar.
                            </p>
                        )}
                    </div>
