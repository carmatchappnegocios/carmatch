...
export default function TermsPage() {
    ...
    const sections = [
        ...
        {
            title: "4. Política de Uso e Integridad de Cuenta",
            icon: <ShieldCheck className="text-green-500" size={24} />,
            content: "CarMatch es una comunidad de confianza basada en el uso legítimo. Empleamos herramientas avanzadas de identificación digital para prevenir el fraude. Cualquier intento de eludir los protocolos de seguridad o crear múltiples perfiles para saturar el mercado de forma artificial conllevará la suspensión inmediata de todas las publicaciones asociadas y el veto permanente del usuario."
        },
        {
