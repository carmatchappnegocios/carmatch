...
export const MarketChat: React.FC<MarketChatProps> = ({
    ...
    const handleSend = async (e?: React.FormEvent) => {
        ...
        try {
            ...
            if (data.aiReasoning && !data.isConversational) {
            ...
            <div className="bg-gradient-to-br from-white/10 via-white/5 to-transparent border border-white/20 rounded-[2.5rem] overflow-hidden flex flex-col shadow-2xl backdrop-blur-3xl ring-1 ring-white/10">
                ...
                <div className="px-5 py-3 border-b border-white/10 bg-white/5 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] font-black text-white/70 uppercase tracking-[0.3em]">Matchmaker AI</span>
                    </div>
                ...
                >
                    ...
                    {messages.map((m, i) => (
                        ...
                        >
                            <div className={`max-w-[90%] px-4 py-2.5 rounded-2xl text-[13px] leading-relaxed shadow-lg backdrop-blur-sm ${m.role === 'user'
                                ? 'bg-gradient-to-tr from-blue-700 to-blue-500 text-white rounded-tr-none font-bold border border-white/20'
                                : 'bg-white/10 text-white border border-white/20 rounded-tl-none font-medium'
                                }`}>
                                {m.role === 'assistant' && (
