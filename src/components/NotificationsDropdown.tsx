    ...
    const fetchNotifications = async () => {
        try {
            ...
            if (res.ok) {
                ...
                // Mostrar en orden cronológico puro (como llegan del servidor)
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-start justify-between gap-2">
                                            ...
                                            {notification.count && notification.count > 1 && (
                                                <span className="flex-shrink-0 bg-primary-600/20 text-primary-400 text-[10px] font-bold px-1.5 py-0.5 rounded-full border border-primary-600/30">
                                                    ×{notification.count}
                                                </span>
                                            )}
                                        </div>
