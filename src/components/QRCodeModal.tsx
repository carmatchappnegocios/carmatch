...
export default function QRCodeModal({ isOpen, onClose }: QRCodeModalProps) {
    ...
    const handleSendWhatsApp = () => {
        ...
        const message = `¡Hola! Te comparto CarMatch Social, la mejor app para comprar y vender vehículos:\n\n${appUrl}\n\n¡Descarga la app y encuentra tu carro ideal!`
                    ...
                    <div className="p-8 flex flex-col items-center">
                        ...
                        <div className="mt-6 w-full flex gap-3">
                            ...
                            >
                                {copied ? (
                                    ...
                                    <>
                                        ...
                                        <span>{t('share_modal.copy_link')}</span>
                                    </>
                                )}
                            </button>
                            ...
                            >
                                ...
                                <span>{t('share_modal.download_qr')}</span>
                            </button>
                        </div>
                        ...
                        <div className="mt-6 w-full">
                            <div className="bg-green-500/5 border border-green-500/20 rounded-xl p-4">
                                <div className="flex items-center gap-2 mb-3">
                                    ...
                                    <h3 className="text-sm font-bold text-green-400">{t('share_modal.send_whatsapp')}</h3>
                                </div>

                                <p className="text-xs text-text-secondary mb-3">
                                    {t('share_modal.write_number')}
                                </p>
                                    ...
                                    >
                                        {sendingWhatsApp ? (
                                            ...
                                            <>
                                                ...
                                                <span className="hidden sm:inline">{t('share_modal.send')}</span>
                                            </>
                                        )}
                                    </button>
                                </div>
