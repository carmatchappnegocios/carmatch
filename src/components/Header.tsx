    ...
    const ctas = useMemo(() => {
        ...
        if (pathname?.startsWith('/map') || pathname?.startsWith('/map-store')) {
            ...
            const marketingHooks = [
                "¿NEGOCIO VACÍO? | ¡LLÉNALO DE CLIENTES!",
                "MÁS VENTAS, MÁS LANA | ¡SÚBETE YA!",
                "¿QUIERES DINERO HOY? | ¡REGÍSTRATE GRATIS!",
                "TU COMPETENCIA YA ESTÁ | ¡NO TE QUEDES FUERA!",
                "¿FALTA DE JALE? | ¡LLÉNATE DE CHAMBA!",
                "CLIENTES REALES HOY | ¡DINERO DIRECTO A TI!",
                "¿QUIERES VENDER MÁS? | ¡APARECE EN EL MAPA!",
                "GANA MÁS DINERO | ¡SÚBETE AL MAPASTORE!",
                "TU NEGOCIO 24/7 | ¡VENDE MIENTRAS DUERMES!",
                "MÁS LLAMADAS = MÁS LANA | ¡ACTÍVATE YA!",
                "¿BUSCAS CLIENTES? | ¡AQUÍ TE ENCUENTRAN!",
                "DOMINA TU ZONA | ¡SÉ EL #1 DEL MAPA!",
                "NO PIERDAS MÁS VENTAS | ¡SÚBETE GRATIS!",
                "EL MAPA QUE DA LANA | ¡ÚNETE A CARMATCH!",
                "¿TALLER SIN GENTE? | ¡LLÉNALO DE TRABAJO!",
                "MULTIPLICA TUS VENTAS | ¡GENERA MÁS HOY!"
            ];
