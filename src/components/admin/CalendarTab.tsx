...
const ALL_ENTRIES: CalendarEntry[] = [
    ...
    makeEntry(7, 6, 'tiktok', '¿Tu taller está perdiendo clientes? 3 razones', 'Taller vacío vs taller lleno', '📱 Sin web. 📞 Sin sistema de citas. ⭐ Sin reseñas. Los clientes buscan en Google.', 'Solución gratis en carmatchapp.net', 'aversion-perdida', ['#Talleres','#Negocio','#Clientes','#CdJuarez'], `Split: empty workshop vs packed workshop, digital notifications showing new appointments`, ad('leads', 'Dueños talleres, 25-55, Cd. Juárez + Chihuahua', 21, 'Feed + Reels', 2), '4:00 PM'),
