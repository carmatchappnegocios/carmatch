...
const ALL_ENTRIES: CalendarEntry[] = [
 ...
 { creenModel: 'Seedance 2.0', creenPrompt: 'Person talking directly to camera with frustrated expression, casual room background. Quick cut to phone screen showing dozens of unread messages. Transition to CarMatch app notification showing serious buyer. TikTok native style, casual, authentic. 9:16 vertical. Silent video, no audio, no text. Post-production in CapCut: add Mexican Spanish voice (TTS), background music, and auto captions (subtitles).' }),
 ...
 { creenModel: 'Seedance 2.0', creenPrompt: 'Screenshot-style testimonial card: "María, Cd. Juárez — Vendí en 3 días" with green checkmark. Background soft green gradient. Transition to calendar animation: Monday "PUBLICADO" → Wednesday "VENDIDO" with stamp effect. UGC authentic style. 9:16 vertical. Silent video, no audio, no text. Post-production in CapCut: add Mexican Spanish voice (TTS), background music, and auto captions (subtitles).' }),
 ...
 { creenModel: 'Seedance 2.0', creenPrompt: 'Counter rapidly ascending from 0 to 500+ with car icons popping up on a map of Cd. Juárez. Orange and red color scheme. Final text "¿EL TUYO?" in bold. Urgency feeling, fast cuts. 9:16 vertical. Silent video, no audio, no text. Post-production in CapCut: add Mexican Spanish voice (TTS), background music, and auto captions (subtitles).' }),
 ...
 { creenModel: 'Seedance 2.0', creenPrompt: 'Red alert screen "ESTAFA" flashing. Examples of common scams: fake check, altered documents. Transition to CarMatch verification badge animation — shield with checkmark. Reassuring tone shift. 9:16 vertical. Silent video, no audio, no text. Post-production in CapCut: add Mexican Spanish voice (TTS), background music, and auto captions (subtitles).' }),
 ...
 { creenModel: 'Seedance 2.0', creenPrompt: 'Person looking at phone with surprised expression. Phone screen shows "$150,000" crossed out and "$180,000" appearing in green. Positive, surprising moment. Transition to CarMatch app valuation screen. 9:16 vertical. Silent video, no audio, no text. Post-production in CapCut: add Mexican Spanish voice (TTS), background music, and auto captions (subtitles).' }),
 ...
 { creenModel: 'Seedance 2.0', creenPrompt: 'Verification process animation: phone icon → photo icon → email icon → green checkmark badge appearing. People silhouettes getting verified one by one. Clean, trustworthy design. Green and white colors. 9:16 vertical. Silent video, no audio, no text. Post-production in CapCut: add Mexican Spanish voice (TTS), background music, and auto captions (subtitles).' }),
 ...
 { creenModel: 'Seedance 2.0', creenPrompt: 'Lone truck sitting in dusty lot, sad mood. Cut to phone notification popping up. Person answering phone with smile. UGC authentic style. 9:16 vertical. Silent video, no audio, no text. Post-production in CapCut: add Mexican Spanish voice (TTS), background music, and auto captions (subtitles).' }),
 ...
 { creenModel: 'Seedance 2.0', creenPrompt: 'Large number "$145,000" animating onto screen with counting effect. Background graph showing price distribution. Car silhouette with question mark. Text "¿EL TUYO?" appearing. Data-driven visual style. 9:16 vertical. Silent video, no audio, no text. Post-production in CapCut: add Mexican Spanish voice (TTS), background music, and auto captions (subtitles).' }),
 ...
 { creenModel: 'Seedance 2.0', creenPrompt: 'Counter animation going from 0 to 500 with car icons appearing. Confetti celebration effect. "GRACIAS Cd. Juárez" fade in. Celebratory mood. 9:16 vertical. Silent video, no audio, no text. Post-production in CapCut: add Mexican Spanish voice (TTS), background music, and auto captions (subtitles).' }),
 ...
 { creenModel: 'Seedance 2.0', creenPrompt: 'Counter descending: 12, 11, 10. cars disappearing from inventory grid. Red urgency colors. Text "ÚLTIMAS UNIDADES" pulsing. Fast-paced, urgent editing. 9:16 vertical. Silent video, no audio, no text. Post-production in CapCut: add Mexican Spanish voice (TTS), background music, and auto captions (subtitles).' }),
 ...
 { creenModel: 'Seedance 2.0', creenPrompt: 'Clock animation: 10:00 AM "PUBLICADO" → 6:00 PM "VENDIDO" stamp. Calendar flip effect. María smiling with phone. Green success colors. 9:16 vertical. Silent video, no audio, no text. Post-production in CapCut: add Mexican Spanish voice (TTS), background music, and auto captions (subtitles).' }),
 ...
 { creenModel: 'Seedance 2.0', creenPrompt: 'Buyer profile card: "Carlos, Cd. Juárez — Busca sedan — $120K-$150K". Car matching animation connecting buyer to vehicle. Green match indicator. Clean, modern UI style. 9:16 vertical. Silent video, no audio, no text. Post-production in CapCut: add Mexican Spanish voice (TTS), background music, and auto captions (subtitles).' }),
 ...
 { creenModel: 'Seedance 2.0', creenPrompt: 'Buyer profile: "Ana — Busca SUV para familia — $150K-$200K". Family silhouette next to SUV icon. Matching animation. Warm family colors. 9:16 vertical. Silent video, no audio, no text. Post-production in CapCut: add Mexican Spanish voice (TTS), background music, and auto captions (subtitles).' }),
 ...
 { creenModel: 'Seedance 2.0', creenPrompt: 'Counter going to 1,000 with people icons connecting on a network map of Cd. Juárez. Celebration confetti. "GRACIAS" in large text. Green and blue colors. 9:16 vertical. Silent video, no audio, no text. Post-production in CapCut: add Mexican Spanish voice (TTS), background music, and auto captions (subtitles).' }),
 ...
 { creenModel: 'Seedance 2.0', creenPrompt: 'Ticking clock countdown. Price tag with "$" being crossed out and higher price appearing. Urgency, fast cuts. 9:16 vertical. Silent video, no audio, no text. Post-production in CapCut: add Mexican Spanish voice (TTS), background music, and auto captions (subtitles).' }),
...
function genWeek5(): CalendarEntry[] {
 ...
 {id:'s05-lun',dn:29,t:'¿Qué tipo de comprador eres?',th:'Identidad',g:'identity',f:'video',cap:'🔵 ¿Sedan, SUV o pick-up?\n\nDescubre cuál es tu estilo.\n\n📲 Link en bio',tags:['#CompradorActivo','#CarMatch','#CdJuarez'],cm:'Seedance 2.0',cp:'Split screen showing three car types: sedan (practical, blue), SUV (family, warm), pick-up (work, rugged). Each side lights up as mentioned. 9:16 vertical. Silent video, no audio, no text. Post-production in CapCut: add Mexican Spanish voice (TTS), background music, and auto captions (subtitles).'},
...
function genWeek6(): CalendarEntry[] {
 ...
 {id:'s06-mie',dn:38,t:'¿A cuánto poner tu auto?',th:'Valuación',g:'curiosity',f:'video',cap:'🟡 ¿A cuánto poner tu auto?\n\nCarMatch te dice.',tags:['#A_cuánto','#Valuación','#CarMatch','#CdJuarez'],cm:'Seedance 2.0',cp:'Person confused with price tag. CarMatch valuation tool calculates. Green checkmark with correct price. "EL PRECIO JUSTO" text. 9:16 vertical. Silent video, no audio, no text. Post-production in CapCut: add Mexican Spanish voice (TTS), background music, and auto captions (subtitles).'},
 {id:'s06-jue',dn:39,t:'Pedro vendió pickup en 5 días',th:'Testimonio',g:'social_proof',f:'video',cap:'🟢 Pedro vendió su pickup en 5 días.\n\nCarMatch funciona.',tags:['#TestimonioReal','#Vendido','#CarMatch','#CdJuarez'],cm:'Seedance 2.0',cp:'Testimonial card: "Pedro, Cd. Juárez — Pickup vendida en 5 días". Timeline animation. Green success theme. UGC style. 9:16 vertical. Silent video, no audio, no text. Post-production in CapCut: add Mexican Spanish voice (TTS), background music, and auto captions (subtitles).'},
 {id:'s06-vie',dn:40,t:'Sin publicar = perdiendo dinero',th:'Pérdida',g:'loss_aversion',f:'video',cap:'🔴 Cada día sin publicar = dinero perdido.\n\nPublica gratis.',tags:['#PérdidaDeDinero','#VendeTuAuto','#CarMatch','#CdJuarez'],cm:'Seedance 2.0',cp:'Money counter decreasing while car sits idle. Calendar days flying by. "CADA DÍA PIERDES $700" text in red. Urgency feeling. 9:16 vertical. Silent video, no audio, no text. Post-production in CapCut: add Mexican Spanish voice (TTS), background music, and auto captions (subtitles).'},
...
function genWeek7(): CalendarEntry[] {
 ...
 {id:'s07-lun',dn:43,t:'MapStore: Negocios verificados',th:'Funciones',g:'authority',f:'video',cap:'🟣 MapStore: talleres y negocios verificados cerca de ti.',tags:['#MapStore','#CarMatch','#CdJuarez'],cm:'Seedance 2.0',cp:'Map interface showing verified business pins popping up around Cd. Juárez. Green checkmarks on each. "NEGOCIOS VERIFICADOS" text. 9:16 vertical. Silent video, no audio, no text. Post-production in CapCut: add Mexican Spanish voice (TTS), background music, and auto captions (subtitles).'},
 {id:'s07-mar',dn:44,t:'GPS: servicios cerca de ti',th:'Funciones',g:'curiosity',f:'video',cap:'🟡 GPS: servicios de auto cerca de ti.',tags:['#GPS','#ServiciosCerca','#CarMatch','#CdJuarez'],cm:'Seedance 2.0',cp:'GPS navigation screen showing nearby car services with distance indicators. "SERVICIOS CERCA DE TI" text. Blue tech style. 9:16 vertical. Silent video, no audio, no text. Post-production in CapCut: add Mexican Spanish voice (TTS), background music, and auto captions (subtitles).'},
...
function genWeek8(): CalendarEntry[] {
 const d: Array<{id:string;dn:number;t:string;th:string;g:GatilloKey;f:Format;cap:string;tags:string[];cm?:string;cp?:string;gp?:string}> = [
 {id:'s08-lun',dn:50,t:'De Juárez, para Juárez',th:'Orgullo',g:'identity',f:'video',cap:'🔵 CarMatch es de Juárez.\n\nPara Juárez.',tags:['#JuárezPride','#HechoEnJuarez','#CarMatch'],cm:'Seedance 2.0',cp:'Cd. Juárez skyline montage: puente, centro, monumentos. Emotional music mood. 9:16 vertical. Silent video, no audio, no text. Post-production in CapCut: add Mexican Spanish voice (TTS), background music, and auto captions (subtitles).'},
 ...
 {id:'s08-vie',dn:54,t:'Tu vecino ya publicó',th:'FOMO',g:'fomo',f:'video',cap:'🟠 Tu vecino ya publicó su auto.\n\n¿Y tú?',tags:['#FOMO','#YaPublicó','#CarMatch','#CdJuarez'],cm:'Seedance 2.0',cp:'Neighbor waving from next house with car keys. Phone notification: "Tu vecino publicó en CarMatch". "¿Y EL TUYO?" text. 9:16 vertical. Silent video, no audio, no text. Post-production in CapCut: add Mexican Spanish voice (TTS), background music, and auto captions (subtitles).'},
...
function genWeek10(): CalendarEntry[] {
 const d: Array<{id:string;dn:number;t:string;th:string;g:GatilloKey;f:Format;cap:string;tags:string[];cm?:string;cp?:string;gp?:string;fest?:boolean;fDate?:string;pre?:number}> = [
 {id:'s10-lun',dn:64,t:'Buen Fin: Ofertas de autos',th:'Buen Fin',g:'loss_aversion',f:'video',cap:'🏷️ Buen Fin: precios que no vuelven.\n\nSolo esta semana.',tags:['#BuenFin','#Ofertas','#CarMatch','#CdJuarez'],cm:'Seedance 2.0',cp:'Price tags with slashes through high prices. New low prices appearing in green. "BUEN FIN" logo with sparkles. Exciting deal energy. 9:16 vertical. Silent video, no audio, no text. Post-production in CapCut: add Mexican Spanish voice (TTS), background music, and auto captions (subtitles).',fest:true,fDate:'2026-11-27',pre:3},
 ...
 {id:'s10-mie',dn:66,t:'Se agotó en 1 hora',th:'Buen Fin',g:'fomo',f:'video',cap:'🟠 Se agotó en 1 hora.\n\n¿Vas a esperar?',tags:['#SeAgotó','#BuenFin','#FOMO','#CarMatch'],cm:'Seedance 2.0',cp:'Counter going from available to "AGOTADO" in 1 hour. Fast clock. "¿VAS A ESPERAR?" text in red. FOMO urgency. 9:16 vertical. Silent video, no audio, no text. Post-production in CapCut: add Mexican Spanish voice (TTS), background music, and auto captions (subtitles).'},
 {id:'s10-jue',dn:67,t:'Último día Buen Fin',th:'Buen Fin',g:'loss_aversion',f:'video',cap:'🏷️ Último día. Mañana se acabó.\n\nNo digas que no te avisamos.',tags:['#ÚltimoDía','#BuenFin','#CarMatch'],cm:'Seedance 2.0',cp:'Countdown to midnight. "ÚLTIMO DÍA" in red. Price tags disappearing. "MAÑANA SE ACABÓ" warning. Urgency. 9:16 vertical. Silent video, no audio, no text. Post-production in CapCut: add Mexican Spanish voice (TTS), background music, and auto captions (subtitles).'},
...
function genWeek11(): CalendarEntry[] {
 ...
 {id:'s11-jue',dn:74,t:'Ofertas navideñas',th:'Navidad',g:'fomo',f:'video',cap:'🎄 Ofertas navideñas.\n\nSolo esta semana.',tags:['#OfertasNavideñas','#Navidad','#CarMatch'],cm:'Seedance 2.0',cp:'Christmas-wrapped price tags with discounts. Snowflakes falling. "OFERTAS NAVIDEñas" in red and green. Festive urgency. 9:16 vertical. Silent video, no audio, no text. Post-production in CapCut: add Mexican Spanish voice (TTS), background music, and auto captions (subtitles).',fest:true,fDate:'2026-12-23',pre:2},
...
function genWeek12(): CalendarEntry[] {
 const d: Array<{id:string;dn:number;t:string;th:string;g:GatilloKey;f:Format;cap:string;tags:string[];cm?:string;cp?:string;gp?:string;fest?:boolean;fDate?:string;pre?:number}> = [
 {id:'s12-lun',dn:78,t:'Año Nuevo: auto nuevo',th:'Año Nuevo',g:'identity',f:'video',cap:'🎆 2027: auto nuevo.\n\nEmpieza el año con CarMatch.',tags:['#AñoNuevo','#2027','#CarMatch'],cm:'Seedance 2.0',cp:'Fireworks over Cd. Juárez skyline. Calendar flipping to 2027. New car appearing. Celebratory. 9:16 vertical. Silent video, no audio, no text. Post-production in CapCut: add Mexican Spanish voice (TTS), background music, and auto captions (subtitles).',fest:true,fDate:'2026-12-30',pre:2},
