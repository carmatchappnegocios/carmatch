...
const ALL_ENTRIES: CalendarEntry[] = [
  ...
  entry('s01-lun', 1, 1, 'Estás perdiendo dinero', 'Educación', 'loss_aversion', 'video',
    ...
    { creenModel: 'Seedance 2.0', creenPrompt: 'Scene 1 (3s): Close-up of a clock spinning fast on a wall, urgency feeling, dark room. Scene 2 (3s): Bills of Mexican pesos flying away from a dusty parked car in an empty lot. Scene 3 (3s): Text overlay "CADA SEMANA PIERDES $2,000" in bold white sans-serif with red glow, dark background. Scene 4 (3s): Person picking up phone, CarMatch app opens on screen, expression changes to hope. Cinematic dark blue-orange color grading, 9:16 vertical. All visible text in Mexican Spanish.' }),
  ...
  entry('s01-mar', 2, 1, 'Opinión impopular: Marketplace no sirve', 'Debate', 'curiosity', 'video',
    ...
    { creenModel: 'Seedance 2.0', creenPrompt: 'Person talking directly to camera with frustrated expression, casual room background. Quick cut to phone screen showing dozens of unread messages with "¿A cuánto está?" texts. Text overlay "50 MENSAJES, 0 SERIOS" in bold red. Transition to CarMatch app notification showing serious buyer. TikTok native style, casual, authentic. 9:16 vertical. All visible text in Mexican Spanish.' }),
  ...
  entry('s01-mie', 3, 1, '¿Sabías que...? 70% se venden barato', 'Datos', 'curiosity', 'carrusel',
    ...
    { carouselSlides: [
      ...
      { slideNumber: 2, prompt: 'Bar chart infographic showing car value declining from left to right. First bar high labeled "Agencia", last bar low labeled "3 meses después". Red gradient. Text "PIERDE 15%" in bold white. Dark background #0f172a.', textOverlay: 'Pierde 15% al sacarlo de agencia' },
      { slideNumber: 3, prompt: 'Calendar infographic, October and November highlighted in orange/gold. Text "MEJOR MES PARA VENDER" in bold white. Car icon with dollar sign. Dark background #0f172a. Clean modern design.', textOverlay: 'Octubre-noviembre: mejor mes para vender' },
    ]}),
  ...
  entry('s01-jue', 4, 1, 'María vendió en 3 días', 'Social Proof', 'social_proof', 'video',
    ...
    { creenModel: 'Seedance 2.0', creenPrompt: 'Screenshot-style testimonial card: "María, Cd. Juárez — Vendí en 3 días" with green checkmark. Background soft green gradient. Transition to calendar animation: Monday "PUBLICADO" → Wednesday "VENDIDO" with stamp effect. UGC authentic style. 9:16 vertical. All visible text in Mexican Spanish.' }),
  ...
  entry('s01-vie', 5, 1, '500+ autos publicados en Juárez', 'Urgencia', 'fomo', 'video',
    ...
    { creenModel: 'Seedance 2.0', creenPrompt: 'Counter rapidly ascending from 0 to 500+ with car icons popping up on a map of Cd. Juárez. Orange and red color scheme. Final text "¿EL TUYO?" in bold. Urgency feeling, fast cuts. 9:16 vertical. All visible text in Mexican Spanish.' }),
  ...
  entry('s01-sab', 6, 1, 'Tu familia depende de ti', 'Seguridad', 'security', 'video',
    ...
    { creenModel: 'Sora 2 Pro', creenPrompt: 'Family in a car, warm lighting. Text overlay "¿TU AUTO ESTÉ SEGURO?" in white. Cut to icons of car maintenance: oil, brakes, tires, lights. Final shot: checklist with green checkmarks appearing one by one. Emotional, warm tone. 9:16 vertical. All visible text in Mexican Spanish.' }),
  ...
  entry('s01-dom', 7, 1, 'Gracias Cd. Juárez 🇲🇽', 'Independencia', 'identity', 'imagen',
    ...
    { geminiPrompt: 'Mexican flag waving majestically over Cd. Juárez skyline at golden hour. Confetti in Mexican flag colors (green, white, red) falling. Text "¡VIVA MÉXICO! 🇲🇽" in gold bold letters. Warm, patriotic, emotional. Professional quality.' }),
  ...
  entry('s02-lun', 8, 2, 'Estafas de autos: cómo protegerte', 'Protección', 'security', 'video',
    ...
    { creenModel: 'Seedance 2.0', creenPrompt: 'Red alert screen "ESTAFA" flashing. Examples of common scams: fake check, altered documents. Transition to CarMatch verification badge animation — shield with checkmark. Reassuring tone shift. 9:16 vertical. All visible text in Mexican Spanish.' }),
  ...
  entry('s02-mar', 9, 2, 'Tu auto vale más de lo que crees', 'Valuación', 'curiosity', 'video',
    ...
    { creenModel: 'Seedance 2.0', creenPrompt: 'Person looking at phone with surprised expression. Phone screen shows "$150,000" crossed out and "$180,000" appearing in green. Positive, surprising moment. Transition to CarMatch app valuation screen. 9:16 vertical. All visible text in Mexican Spanish.' }),
  ...
  entry('s02-mie', 10, 2, '4 señales de mantenimiento YA', 'Cuidado', 'security', 'carrusel',
    ...
    { carouselSlides: [
      { slideNumber: 1, prompt: 'Warning icon with brake disc. Red alert style. Text "SEÑAL 1" in bold. Dark background. Clean infographic.', textOverlay: 'Ruido extraño al frenar' },
  ...
  entry('s02-jue', 11, 2, 'Cada usuario verificado', 'Verificación', 'social_proof', 'video',
    ...
    { creenModel: 'Seedance 2.0', creenPrompt: 'Verification process animation: phone icon → photo icon → email icon → green checkmark badge appearing. People silhouettes getting verified one by one. Clean, trustworthy design. Green and white colors. 9:16 vertical. All visible text in Mexican Spanish.' }),
  ...
  entry('s02-vie', 12, 2, 'Los más buscados de la semana', 'Tendencia', 'fomo', 'imagen',
    ...
    { geminiPrompt: 'Top 3 ranking infographic with car silhouettes. Number 1 Nissan Sentra, 2 VW Jetta, 3 Chevrolet Aveo. Orange accent color on dark background #0f172a. Text "ESTA SEMANA EN JUÁREZ" at top. Clean, modern.' }),
  ...
  entry('s02-sab', 13, 2, 'Juan vendió su truck en 2 horas', 'Testimonio', 'social_proof', 'video',
    ...
    { creenModel: 'Seedance 2.0', creenPrompt: 'Lone truck sitting in dusty lot, sad mood. Cut to phone notification: "3 llamadas nuevas". Person answering phone with smile. Text overlay "3 LLAMADAS EN 2 HORAS" in green bold. UGC authentic style. 9:16 vertical. All visible text in Mexican Spanish.' }),
  ...
  entry('s02-dom', 14, 2, 'Domingo de revisión', 'Cuidado', 'security', 'imagen',
    ...
    { geminiPrompt: 'Car parked on Sunday morning, warm light. Floating checklist with green checkmarks: Aceite, Llantas, Frenos, Luces. Text "5 MINUTOS = $50,000 AHORRADOS" in white. Calm, reassuring tone.' }),
  ...
  entry('s03-mar', 16, 3, 'Precio promedio: $145,000', 'Valuación', 'curiosity', 'video',
    ...
    { creenModel: 'Seedance 2.0', creenPrompt: 'Large number "$145,000" animating onto screen with counting effect. Background graph showing price distribution. Car silhouette with question mark. Text "¿EL TUYO?" appearing. Data-driven visual style. 9:16 vertical. All visible text in Mexican Spanish.' }),
  ...
  entry('s03-mie', 17, 3, 'Mejor mes para vender: octubre', 'Estrategia', 'authority', 'carrusel',
    ...
    { carouselSlides: [
      { slideNumber: 1, prompt: 'Calendar with October highlighted in bright orange. Car icon with dollar sign. Text "EL MEJOR MES" in bold white. Dark background.', textOverlay: 'Octubre: el mejor mes para vender' },
  ...
  entry('s03-jue', 18, 3, '500 autos vendidos en CarMatch', 'Milestone', 'social_proof', 'video',
    ...
    { creenModel: 'Seedance 2.0', creenPrompt: 'Counter animation going from 0 to 500 with car icons appearing. Confetti celebration effect. Text "500 AUTOS VENDIDOS" in green bold. "GRACIAS Cd. Juárez" fade in. Celebratory mood. 9:16 vertical. All visible text in Mexican Spanish.' }),
  ...
  entry('s03-vie', 19, 3, 'Se agotó — solo quedan 12', 'Escasez', 'fomo', 'video',
    ...
    { creenModel: 'Seedance 2.0', creenPrompt: 'Counter descending: 12, 11, 10... cars disappearing from inventory grid. Red urgency colors. Text "ÚLTIMAS UNIDADES" pulsing. Fast-paced, urgent editing. 9:16 vertical. All visible text in Mexican Spanish.' }),
  ...
  entry('s03-sab', 20, 3, 'María vendió en 1 día', 'Testimonio', 'social_proof', 'video',
    ...
    { creenModel: 'Seedance 2.0', creenPrompt: 'Clock animation: 10:00 AM "PUBLICADO" → 6:00 PM "VENDIDO" stamp. Calendar flip effect. María smiling with phone. Green success colors. 9:16 vertical. All visible text in Mexican Spanish.' }),
  ...
  entry('s03-dom', 21, 3, 'Domingo: revisa tus documentos', 'Organización', 'security', 'imagen',
    ...
    { geminiPrompt: 'Checklist of car documents with green checkmarks: Tenencia, Verificación, Seguro. Calm Sunday morning light. Dark background. Text "¿TODO AL DÍA?" in white.' }),
  ...
  entry('s04-lun', 22, 4, '3 razones por las que te compran', 'Psicología', 'authority', 'carrusel',
    ...
    { carouselSlides: [
      { slideNumber: 1, prompt: 'Camera icon with sparkles. Text "FOTOS PROFESIONALES" in bold white. Purple accent. Dark background.', textOverlay: '1. Fotos que captan atención' },
      { slideNumber: 2, prompt: 'Price tag icon with checkmark. Text "PRECIO JUSTO" in bold white. Green accent. Dark background.', textOverlay: '2. Precio que genera confianza' },
      { slideNumber: 3, prompt: 'Shield with checkmark icon. Text "VENDEDOR VERIFICADO" in bold white. Blue accent. Dark background.', textOverlay: '3. Confianza que cierra la venta' },
    ]}),
  ...
  entry('s04-mar', 23, 4, 'Carlos busca sedan — $120K-$150K', 'Demanda Real', 'social_proof', 'video',
    ...
    { creenModel: 'Seedance 2.0', creenPrompt: 'Buyer profile card: "Carlos, Cd. Juárez — Busca sedan — $120K-$150K". Car matching animation connecting buyer to vehicle. Green match indicator. Clean, modern UI style. 9:16 vertical. All visible text in Mexican Spanish.' }),
  ...
  entry('s04-mie', 24, 4, 'Ana busca SUV — $150K-$200K', 'Demanda Real', 'social_proof', 'video',
    ...
    { creenModel: 'Seedance 2.0', creenPrompt: 'Buyer profile: "Ana — Busca SUV para familia — $150K-$200K". Family silhouette next to SUV icon. Matching animation. Warm family colors. 9:16 vertical. All visible text in Mexican Spanish.' }),
  ...
  entry('s04-jue', 25, 4, '1,000 usuarios en CarMatch', 'Milestone', 'social_proof', 'video',
    ...
    { creenModel: 'Seedance 2.0', creenPrompt: 'Counter going to 1,000 with people icons connecting on a network map of Cd. Juárez. Celebration confetti. "GRACIAS" in large text. Green and blue colors. 9:16 vertical. All visible text in Mexican Spanish.' }),
  ...
  entry('s04-vie', 26, 4, 'Último día de este precio', 'Urgencia', 'fomo', 'video',
    ...
    { creenModel: 'Seedance 2.0', creenPrompt: 'Ticking clock countdown. Price tag with "$" being crossed out and higher price appearing. Text "ÚLTIMO DÍA" in bold red pulsing. Urgency, fast cuts. 9:16 vertical. All visible text in Mexican Spanish.' }),
  ...
  entry('s04-sab', 27, 4, '50 autos vendidos esta semana', 'Momentum', 'social_proof', 'imagen',
    ...
    { geminiPrompt: 'Large number "50" in green with car icons and checkmarks. Text "AUTOS VENDIDOS ESTA SEMANA" in white. Dark background. Momentum energy.' }),
  ...
  entry('s04-dom', 28, 4, 'Gracias por un mes increíble', 'Agradecimiento', 'identity', 'imagen',
    ...
    { geminiPrompt: 'Month 1 celebration graphic. Calendar icon with "1" and confetti. Text "GRACIAS Cd. JUÁREZ" in white. Blue gradient background. Warm, grateful tone.' }),
]
...
function genWeek5(): CalendarEntry[] {
  const d: Array<{id:string;dn:number;t:string;th:string;g:GatilloKey;f:Format;cap:string;tags:string[];cp?:string;cm?:string;gp?:string}> = [
    {id:'s05-lun',dn:29,t:'¿Qué tipo de comprador eres?',th:'Identidad',g:'identity',f:'video',cap:'🔵 ¿Sedan, SUV o pick-up?\n\nDescubre cuál es tu estilo.\n\n📲 Link en bio',tags:['#CompradorActivo','#CarMatch','#CdJuarez'],cm:'Seedance 2.0',cp:'Split screen showing three car types: sedan (practical, blue), SUV (family, warm), pick-up (work, rugged). Text "¿CUÁL ES TU ESTILO?" in bold white. Each side lights up as mentioned. 9:16 vertical. All visible text in Mexican Spanish.'},
    ...
    {id:'s05-mie',dn:31,t:'Prueba: ¿vale tu auto?',th:'Curiosidad',g:'curiosity',f:'video',cap:'🟡 ¿Vale la pena tu auto?\n\nDescúbrelo gratis en CarMatch.',tags:['#ValuaTuAuto','#CarMatch','#CdJuarez'],cm:'Seedance 2.0',cp:'Person typing car info into phone. Valuation result appears: price in green with upward arrow. Surprised happy expression. "¿VALE MÁS DE LO QUE CREES?" text. 9:16 vertical. All visible text in Mexican Spanish.'},
    {id:'s05-jue',dn:32,t:'80% miran, 20% compran',th:'Prueba Social',g:'social_proof',f:'video',cap:'🟢 El 80% solo mira.\n\nEl 20% compra.\n\nCarMatch tiene compradores reales.',tags:['#CompradoresReales','#CarMatch','#CdJuarez'],cm:'Seedance 2.0',cp:'Pie chart: 80% gray "SOLO MIRAN", 20% green "COMPRAN DE VERDAD". Transition to CarMatch buyer notification. Data visualization style. 9:16 vertical. All visible text in Mexican Spanish.'},
    {id:'s05-vie',dn:33,t:'Se fue tu modelo',th:'Urgencia',g:'fomo',f:'imagen',cap:'🟠 Se vendió el último de tu modelo.\n\n¿Ya publicaste el tuyo?',tags:['#SeFue','#FOMO','#CarMatch','#CdJuarez'],gp:'Car silhouette fading away with "VENDIDO" stamp in red. Text "¿Y EL TUYO?" in bold. Dark background.'},
    {id:'s05-sab',dn:34,t:'Tu auto soñado está aquí',th:'Identidad',g:'identity',f:'video',cap:'🔵 Tu auto soñado está en CarMatch.\n\nBúscalo ahora.',tags:['#AutoSoñado','#CarMatch','#CdJuarez'],cm:'Seedance 2.0',cp:'Dreamy sequence: person imagining their ideal car. Car appears with sparkle effect. Text "TU AUTO SOÑADO" in gold. Hopeful, aspirational mood. 9:16 vertical. All visible text in Mexican Spanish.'},
    {id:'s05-dom',dn:35,t:'Domingo de desear un auto',th:'Identidad',g:'identity',f:'imagen',cap:'🔵 Domingo: ¿de qué auto sueñas?\n\nMira los que hay en CarMatch.',tags:['#DomingoDeSoñar','#CarMatch','#CdJuarez'],gp:'Cozy Sunday scene, person looking at car listings on phone. Warm lighting. Text "¿DE QUÉ AUTO SUEÑAS?" in white.'},
  ]
...
function genWeek6(): CalendarEntry[] {
  const d: Array<{id:string;dn:number;t:string;th:string;g:GatilloKey;f:Format;cap:string;tags:string[];cm?:string;cp?:string;gp?:string}> = [
    {id:'s06-lun',dn:36,t:'Tu auto vale más de lo que crees',th:'Valuación',g:'curiosity',f:'video',cap:'🟡 Tu auto vale $20,000 más.\n\nDescúbrelo.',tags:['#ValuaTuAuto','#CarMatch','#CdJuarez'],cm:'Seedance 2.0',cp:'Person shocked looking at phone. Price comparison: low crossed out, higher value revealed. "VALE MÁS DE LO QUE CREES" text. 9:16 vertical. All visible text in Mexican Spanish.'},
    ...
    {id:'s06-mie',dn:38,t:'¿A cuánto poner tu auto?',th:'Valuación',g:'curiosity',f:'video',cap:'🟡 ¿A cuánto poner tu auto?\n\nCarMatch te dice.',tags:['#A_cuánto','#Valuación','#CarMatch','#CdJuarez'],cm:'Seedance 2.0',cp:'Person confused with price tag. CarMatch valuation tool calculates. Green checkmark with correct price. "EL PRECIO JUSTO" text. 9:16 vertical. All visible text in Mexican Spanish.'},
    {id:'s06-jue',dn:39,t:'Pedro vendió pickup en 5 días',th:'Testimonio',g:'social_proof',f:'video',cap:'🟢 Pedro vendió su pickup en 5 días.\n\nCarMatch funciona.',tags:['#TestimonioReal','#Vendido','#CarMatch','#CdJuarez'],cm:'Seedance 2.0',cp:'Testimonial card: "Pedro, Cd. Juárez — Pickup vendida en 5 días". Timeline animation. Green success theme. UGC style. 9:16 vertical. All visible text in Mexican Spanish.'},
    {id:'s06-vie',dn:40,t:'Sin publicar = perdiendo dinero',th:'Pérdida',g:'loss_aversion',f:'video',cap:'🔴 Cada día sin publicar = dinero perdido.\n\nPublica gratis.',tags:['#PérdidaDeDinero','#VendeTuAuto','#CarMatch','#CdJuarez'],cm:'Seedance 2.0',cp:'Money counter decreasing while car sits idle. Calendar days flying by. "CADA DÍA PIERDES $700" text in red. Urgency feeling. 9:16 vertical. All visible text in Mexican Spanish.'},
    {id:'s06-sab',dn:41,t:'Vende sin comisiones',th:'Identidad',g:'identity',f:'imagen',cap:'🔵 Cero comisiones.\n\nCero intermediarios.\n\nVende directo.',tags:['#SinComisiones','#CarMatch','#CdJuarez'],gp:' crossed-out commission percentage "0%" with money staying in hand. Text "CERO COMISIONES" in green. Dark background.'},
...
function genWeek7(): CalendarEntry[] {
  ...
  const d: Array<{id:string;dn:number;t:string;th:string;g:GatilloKey;f:Format;cap:string;tags:string[];cm?:string;cp?:string;gp?:string;fest?:boolean;fDate?:string;pre?:number}> = [
    {id:'s07-lun',dn:43,t:'MapStore: Negocios verificados',th:'Funciones',g:'authority',f:'video',cap:'🟣 MapStore: talleres y negocios verificados cerca de ti.',tags:['#MapStore','#CarMatch','#CdJuarez'],cm:'Seedance 2.0',cp:'Map interface showing verified business pins popping up around Cd. Juárez. Green checkmarks on each. "NEGOCIOS VERIFICADOS" text. 9:16 vertical. All visible text in Mexican Spanish.'},
    {id:'s07-mar',dn:44,t:'GPS: servicios cerca de ti',th:'Funciones',g:'curiosity',f:'video',cap:'🟡 GPS: servicios de auto cerca de ti.',tags:['#GPS','#ServiciosCerca','#CarMatch','#CdJuarez'],cm:'Seedance 2.0',cp:'GPS navigation screen showing nearby car services with distance indicators. "SERVICIOS CERCA DE TI" text. Blue tech style. 9:16 vertical. All visible text in Mexican Spanish.'},
    ...
    {id:'s07-dom',dn:49,t:'Día de Muertos: paz y descanso',th:'Día de Muertos',g:'identity',f:'imagen',cap:'💀 Día de Muertos: paz y descanso.\n\nRecuerda a los tuyos.',tags:['#DíaDeMuertos','#Paz','#CarMatch','#CdJuarez'],gp:'Ofrenda with candles and marigolds. Peaceful, respectful. Text "PAZ Y DESCANSO" in warm gold. Dark background.',fest:true,fDate:'2026-11-02'},
  ]
...
function genWeek8(): CalendarEntry[] {
  const d: Array<{id:string;dn:number;t:string;th:string;g:GatilloKey;f:Format;cap:string;tags:string[];cm?:string;cp?:string;gp?:string}> = [
    {id:'s08-lun',dn:50,t:'De Juárez, para Juárez',th:'Orgullo',g:'identity',f:'video',cap:'🔵 CarMatch es de Juárez.\n\nPara Juárez.',tags:['#JuárezPride','#HechoEnJuarez','#CarMatch'],cm:'Seedance 2.0',cp:'Cd. Juárez skyline montage: puente, centro, monumentos. Text "DE JUÁREZ, PARA JUÁREZ" in white. Emotional music mood. 9:16 vertical. All visible text in Mexican Spanish.'},
    {id:'s08-mar',dn:51,t:'Frontera más activa de México',th:'Orgullo',g:'authority',f:'imagen',cap:'🟣 Juárez: la frontera más activa.\n\nTu auto se vende aquí.',tags:['#FronteraDigital','#CarMatch','#CdJuarez'],gp:'Cd. Juárez border bridge at sunset. Text "LA FRONTERA MÁS ACTIVA" in bold. Purple accent.'},
    {id:'s08-mie',dn:52,t:'Antes y después de CarMatch',th:'Transformación',g:'social_proof',f:'video',cap:'🟢 Antes: 2 meses vendiendo.\n\nDespués: 3 días.',tags:['#AntesYDespués','#CarMatch','#CdJuarez'],cm:'Seedance 2.0',cp:'Split screen before/after: Left "2 MESES" with sad face and dusty car. Right "3 DÍAS" with happy face and "VENDIDO" stamp. Transformation effect. 9:16 vertical. All visible text in Mexican Spanish.'},
    {id:'s08-jue',dn:53,t:'Orgullo juarense: los mejores autos',th:'Orgullo',g:'identity',f:'imagen',cap:'🔵 Juárez tiene los mejores autos.\n\nOrgullo juarense.',tags:['#OrgulloJuarense','#CarMatch','#CdJuarez'],gp:'Cars lined up with Cd. Juárez flag. Text "LOS MEJORES DE JUÁREZ" in bold. Patriotic blue.'},
    {id:'s08-vie',dn:54,t:'Tu vecino ya publicó',th:'FOMO',g:'fomo',f:'video',cap:'🟠 Tu vecino ya publicó su auto.\n\n¿Y tú?',tags:['#FOMO','#YaPublicó','#CarMatch','#CdJuarez'],cm:'Seedance 2.0',cp:'Neighbor waving from next house with car keys. Phone notification: "Tu vecino publicó en CarMatch". "¿Y EL TUYO?" text. 9:16 vertical. All visible text in Mexican Spanish.'},
    {id:'s08-sab',dn:55,t:'Sábado de paseo virtual',th:'Diversión',g:'identity',f:'imagen',cap:'🔵 Sábado de paseo: mira autos en CarMatch.',tags:['#SábadoDePaseo','#CarMatch','#CdJuarez'],gp:'Person relaxing on couch browsing car listings on phone. Cozy Saturday vibes. Text "PASEO VIRTUAL" in white.'},
    {id:'s08-dom',dn:56,t:'Gracias Juárez — 2 meses',th:'Agradecimiento',g:'identity',f:'imagen',cap:'🔵 2 meses en Juárez.\n\nGracias.',tags:['#2Meses','#Gracias','#CarMatch','#CdJuarez'],gp:'Calendar showing 2 months. Heart icon. Text "GRACIAS Cd. JUÁREZ" in warm white. Blue background.'},
  ]
...
function genWeek9(): CalendarEntry[] {
  const d: Array<{id:string;dn:number;t:string;th:string;g:GatilloKey;f:Format;cap:string;tags:string[];cm?:string;cp?:string;gp?:string;fest?:boolean;fDate?:string;pre?:number}> = [
    {id:'s09-lun',dn:57,t:'Día de la Revolución: México avanza',th:'Revolución',g:'identity',f:'video',cap:'🇲🇽 Día de la Revolución.\n\nMéxico avanza. Tú también.',tags:['#Revolución','#16DeNoviembre','#CarMatch','#CdJuarez'],cm:'Sora 2 Pro',cp:'Historical revolution imagery transitioning to modern Cd. Juárez progress. Mexican flag colors. Text "MÉXICO AVANZA, TÚ TAMBIÉN" in gold. Patriotic, inspiring. 9:16 vertical. All visible text in Mexican Spanish.',fest:true,fDate:'2026-11-16',pre:3},
    {id:'s09-mar',dn:58,t:'Buen Fin se acerca',th:'Pre-Buen Fin',g:'fomo',f:'video',cap:'🟠 El Buen Fin se acerca.\n\nPrepárate.',tags:['#BuenFin','#SeAcerca','#CarMatch','#CdJuarez'],cm:'Seedance 2.0',cp:'Calendar pages flipping to November 27. Countdown timer. "BUEN FIN SE ACERCA" text pulsing in orange. Excitement building. 9:16 vertical. All visible text in Mexican Spanish.'},
    {id:'s09-mie',dn:59,t:'Precios bajos del Buen Fin',th:'Pre-Buen Fin',g:'loss_aversion',f:'imagen',cap:'🔴 Precios bajos del Buen Fin.\n\nNo esperes.',tags:['#BuenFin','#PreciosBajos','#CarMatch','#CdJuarez'],gp:'Price tags dropping down with "BAJA" arrows. Red urgency. Text "PRECIOS QUE NO VUELVEN" in white.'},
    ...
    {id:'s09-dom',dn:63,t:'Domingo de anticipación',th:'FOMO',g:'fomo',f:'imagen',cap:'🟠 Domingo de anticipación.\n\nMañana Buying.',tags:['#DomingoDeAnticipación','#BuenFin','#CarMatch'],gp:'Calm before the storm. Person preparing shopping list. "MAÑANA ES EL DÍA" text. Warm anticipation.'},
  ]
...
function genWeek10(): CalendarEntry[] {
  const d: Array<{id:string;dn:number;t:string;th:string;g:GatilloKey;f:Format;cap:string;tags:string[];cm?:string;cp?:string;gp?:string;fest?:boolean;fDate?:string;pre?:number}> = [
    {id:'s10-lun',dn:64,t:'Buen Fin: Ofertas de autos',th:'Buen Fin',g:'loss_aversion',f:'video',cap:'🏷️ Buen Fin: precios que no vuelven.\n\nSolo esta semana.',tags:['#BuenFin','#Ofertas','#CarMatch','#CdJuarez'],cm:'Seedance 2.0',cp:'Price tags with slashes through high prices. New low prices appearing in green. "BUEN FIN" logo with sparkles. Exciting deal energy. 9:16 vertical. All visible text in Mexican Spanish.',fest:true,fDate:'2026-11-27',pre:3},
    ...
    {id:'s10-mie',dn:66,t:'Se agotó en 1 hora',th:'Buen Fin',g:'fomo',f:'video',cap:'🟠 Se agotó en 1 hora.\n\n¿Vas a esperar?',tags:['#SeAgotó','#BuenFin','#FOMO','#CarMatch'],cm:'Seedance 2.0',cp:'Counter going from available to "AGOTADO" in 1 hour. Fast clock. "¿VAS A ESPERAR?" text in red. FOMO urgency. 9:16 vertical. All visible text in Mexican Spanish.'},
    {id:'s10-jue',dn:67,t:'Último día Buen Fin',th:'Buen Fin',g:'loss_aversion',f:'video',cap:'🏷️ Último día. Mañana se acabó.\n\nNo digas que no te avisamos.',tags:['#ÚltimoDía','#BuenFin','#CarMatch'],cm:'Seedance 2.0',cp:'Countdown to midnight. "ÚLTIMO DÍA" in red. Price tags disappearing. "MAÑANA SE ACABÓ" warning. Urgency. 9:16 vertical. All visible text in Mexican Spanish.'},
...
function genWeek11(): CalendarEntry[] {
  const d: Array<{id:string;dn:number;t:string;th:string;g:GatilloKey;f:Format;cap:string;tags:string[];cm?:string;cp?:string;gp?:string;fest?:boolean;fDate?:string;pre?:number}> = [
    ...
    {id:'s11-mie',dn:73,t:'Familia + auto seguro',th:'Navidad',g:'security',f:'imagen',cap:'🎄 Tu familia merece un auto seguro.\n\nNavidad en CarMatch.',tags:['#Familia','#AutoSeguro','#Navidad','#CarMatch'],gp:'Happy family next to safe car. Christmas lights. Text "TU FAMILIA MERECE SEGURIDAD" in warm white.',fest:true,fDate:'2026-12-22',pre:3},
    {id:'s11-jue',dn:74,t:'Ofertas navideñas',th:'Navidad',g:'fomo',f:'video',cap:'🎄 Ofertas navideñas.\n\nSolo esta semana.',tags:['#OfertasNavideñas','#Navidad','#CarMatch'],cm:'Seedance 2.0',cp:'Christmas-wrapped price tags with discounts. Snowflakes falling. "OFERTAS NAVIDEñas" in red and green. Festive urgency. 9:16 vertical. All visible text in Mexican Spanish.',fest:true,fDate:'2026-12-23',pre:2},
...
function genWeek12(): CalendarEntry[] {
  const d: Array<{id:string;dn:number;t:string;th:string;g:GatilloKey;f:Format;cap:string;tags:string[];cm?:string;cp?:string;gp?:string;fest?:boolean;fDate?:string;pre?:number}> = [
    {id:'s12-lun',dn:78,t:'Año Nuevo: auto nuevo',th:'Año Nuevo',g:'identity',f:'video',cap:'🎆 2027: auto nuevo.\n\nEmpieza el año con CarMatch.',tags:['#AñoNuevo','#2027','#CarMatch'],cm:'Seedance 2.0',cp:'Fireworks over Cd. Juárez skyline. Calendar flipping to 2027. New car appearing. Text "AÑO NUEVO, AUTO NUEVO" in gold. Celebratory. 9:16 vertical. All visible text in Mexican Spanish.',fest:true,fDate:'2026-12-30',pre:2},
    ...
    {id:'s12-vie',dn:82,t:'Metas 2027: auto nuevo',th:'Año Nuevo',g:'identity',f:'imagen',cap:'🔵 Metas 2027: auto nuevo.\n\nCarMatch te ayuda.',tags:['#Metas2027','#CarMatch'],gp:'Goal target icon with car. "METAS 2027" text. Motivational blue.'},
    {id:'s12-sab',dn:83,t:'Nuevos autos 2027',th:'Año Nuevo',g:'fomo',f:'imagen',cap:'🟠 Nuevos autos para 2027.\n\nCarMatch los tiene.',tags:['#NuevosAutos2027','#CarMatch'],gp:'Fresh inventory of cars for 2027. "NUEVOS AUTOS" text in orange.'},
    {id:'s12-dom',dn:84,t:'Gracias 2026 — Hola 2027',th:'Despedida',g:'identity',f:'imagen',cap:'🔵 Gracias 2026.\n\nHola 2027.\n\nGracias Juárez.',tags:['#Gracias2026','#Hola2027','#CarMatch','#CdJuarez'],gp:'Two calendars: "2026 GRACIAS" fading out, "2027 HOLA" bright. Warm transition.'},
  ]
