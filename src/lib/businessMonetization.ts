...
export function calculateBusinessExpiration(isFirstBusiness: boolean): Date | null {
    // 🛡️ ESTRATEGIA DE APROBACIÓN: Todos los negocios tienen 3 meses gratis durante el periodo de revisión
    // para evitar que los testers de Google vean muros de pago al crear múltiples negocios.
