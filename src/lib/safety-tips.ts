...
// Función para obtener un consejo por categoría
export function getTipByCategory(category: string): typeof SAFETY_TIPS[0] {
    const filtered = SAFETY_TIPS.filter(tip => tip.category === category)
